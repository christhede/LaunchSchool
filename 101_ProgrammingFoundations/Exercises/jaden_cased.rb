...
# method takes a string as a paramter
# itereate through sentance and use capitalize on every word 

def to_jaden_case(string)
  string.split.map {|x| x.capitalize}.join(' ')
end

p to_jaden_case("How can mirrors be real if our eyes aren't real")